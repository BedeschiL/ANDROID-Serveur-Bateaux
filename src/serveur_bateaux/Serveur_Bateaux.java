 ...
 * @author luybed
 */
public class Serveur_Bateaux extends javax.swing.JFrame implements ConsoleServeur {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Serveur_Bateaux.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Serveur_Bateaux().setVisible(true);
            }
        });
    }
